...
public class PopularRestaurentsAdapter extends RecyclerView.Adapter<PopularRestaurentsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PopularRestaurentsViewHolder holder, int position) {
        holder.binding.NameOfRestrount.setText(foodModelList.get(position).getRestaurantsName());
