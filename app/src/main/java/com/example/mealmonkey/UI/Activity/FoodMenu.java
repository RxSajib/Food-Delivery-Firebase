...
import com.example.mealmonkey.databinding.FoodmenuBinding;
...
public class FoodMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.foodmenu);
    ...
    private void getdata_from_server() {
        ...
        binding.RecyclerView.setLayoutManager(new LinearLayoutManager(FoodMenu.this));
        foodMenuAdapter = new FoodMenuAdapter();
        binding.RecyclerView.setAdapter(foodMenuAdapter);
        networkViewModel.GetFoodData(DataManager.Food, 20).observe(this, new Observer<List<FoodData>>() {
            @Override
            public void onChanged(List<FoodData> foodData) {
                if(foodData != null){
                    ...
                    foodMenuAdapter.SetOnClickLisiner(Position -> {
                        ...
                        Animatoo.animateSlideLeft(FoodMenu.this);
                    });
    ...
    private void init_view(){
        binding.BackButton.setOnClickListener(v -> {
          finish();
            Animatoo.animateSlideRight(FoodMenu.this);
        });
    }
