...
public class PromotionsGET {
    ...
    public LiveData<List<FoodData>> GetPromotionFood(String Data, int Limit){
        ...
        Query SearchQuery = MAllFoodRef.whereEqualTo(DataManager.Promotions, Data).orderBy(DataManager.Timestamp, Query.Direction.DESCENDING).limit(Limit);
